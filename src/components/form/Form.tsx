...
function FormContato() {
  ...
  return (
    ...
    <div className="flex items-center justify-center pb-4 w-full"
        ...
        <div className="flex flex-col justify-center rounded-2xl bg-gray-200 text-black w-full max-w-5xl min-h-0 my-4 mx-auto px-8 py-8 shadow-2xl transition-all">
