                ...
                <div className="flex flex-col items-center gap-1">
                    ...
                    <div className="flex gap-4 items-center">
                        <a href="https://www.instagram.com/_allcare/" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors">
                            <InstagramLogoIcon size={32} weight='bold' className="hover:text-emerald-500 cursor-pointer transition-colors w-6 h-6 sm:w-8 sm:h-8" />
                        </a>
                        {/* Linktree */}
                        <a href="https://linktr.ee/allcare_org" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" className="block w-6 h-6 sm:w-8 sm:h-8">
                        ...
                        <a href="https://github.com/Javascript13-Grupo02/Projeto-integrador-05-FitCare-Frontend" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors">
                            <GithubLogoIcon size={32} weight='bold' className="hover:text-emerald-500 cursor-pointer transition-colors w-6 h-6 sm:w-8 sm:h-8" />
                        </a>
                    </div>
                </div>
