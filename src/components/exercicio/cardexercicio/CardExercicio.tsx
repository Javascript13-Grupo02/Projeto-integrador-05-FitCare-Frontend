      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="px-6 py-5 flex flex-col flex-1">
          <div className="flex-1 flex flex-col gap-2">
            <h4 className="text-emerald-500 text-sm font-semibold uppercase tracking-widest min-h-10 flex items-center">
              {exercicio.nome}
            </h4>

            <div className="min-h-12.5 flex flex-col justify-center">
